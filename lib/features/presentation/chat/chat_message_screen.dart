...
class _ChatMessageScreenState extends State<ChatMessageScreen>
  ...
  List<Widget> _buildMessageWidgets(List<ChatMessage> messages) {
    ...
    for (int i = 0; i < reversedMessages.length; i++) {
      ...
      final dateString = messageDate.humanReadableDate;
          ...
          children: [
            CircleAvatar(
              ...
              foregroundImage: NetworkImage(
                "https://ui-avatars.com/api/?name=${Uri.encodeComponent(widget.receiverName)}&background=${Theme.of(context).primaryColorDark}&color=fff",
              ),
              child: Text(
